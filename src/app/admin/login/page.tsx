...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black p-4">
      ...
      <div className="absolute right-0 top-0 h-96 w-96 rounded-full bg-yellow-400/5 blur-3xl" />
      <div className="absolute bottom-0 left-0 h-96 w-96 rounded-full bg-yellow-400/5 blur-3xl" />

      <div className="relative z-10 w-full max-w-md">
        <div className="mb-8 text-center">
          <div className="mb-4 inline-flex h-20 w-20 items-center justify-center rounded-full border-2 border-yellow-400 bg-yellow-400/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-700 bg-black px-4 py-3 text-white placeholder-gray-500 focus:border-transparent focus:ring-2 focus:ring-yellow-400"
                placeholder="admin"
                required
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-yellow-400 py-3 font-bold text-black shadow-lg shadow-yellow-400/20 transition hover:bg-yellow-500 disabled:opacity-50"
            >
        ...
        <div className="mt-6 text-center">
          <Link href="/" className="text-gray-400 transition hover:text-yellow-400">
            ← Volver al sitio
          </Link>
        </div>
      </div>
